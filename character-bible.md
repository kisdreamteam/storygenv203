...
Stories are designed for kindergarten, preschool, ESL/EFL, and early literacy classrooms. Adventures are grounded in everyday settings: home, school, park, market, and neighborhood.
...
Nina & Nino ── students of ── Ms. Lee
Nina & Nino ── friends with ── Sam
Family ── owns ── Biscuit
```
...
* No scary, violent, or overly realistic imagery
...
* Short sentences (mostly 4–8 words for Nino; slightly longer for Nina)
* Repeat target vocabulary naturally across pages
* Avoid sarcasm, idioms, and abstract moralizing
* Use positive framing: "Let's try again" rather than "You failed"
* Questions should invite participation: "Can you see the red ball?"

## Narration style

* Third-person past tense or simple present tense (pick one per story and stay consistent)
* One clear action or idea per page
* Page endings may gently set up the next page

## Educational voice

* Introduce vocabulary in context before labeling it explicitly
* Reinforce the learning goal without breaking the story flow
* Let Nina or Ms. Lee model new words; let Nino repeat or use them
...
* Themes and topics recently covered (to reduce accidental duplication)

## What teachers may override
...
* Avoid reusing the same plot structure back-to-back
* Reuse characters and settings; vary vocabulary presentation and small plot beats
* Callbacks to prior stories are welcome when subtle (e.g., "Remember when we found the blue shell?")
...
1. Introduce setting and learning context
2–3. Establish goal or problem
4–8. Explore, practice vocabulary, small setbacks
9–10. Resolution through cooperation or discovery
11. Reflect on what was learned
12. Warm closing image or callback
...
* Educational usefulness over creativity alone
* Concrete nouns and action verbs young learners can act out
* Positive social behavior (sharing, asking for help, trying again)
* Multisensory cues (see, hear, touch, smell) when appropriate

Avoid:

* Fear-based lessons
* Shame or punishment as teaching tools
* Complex subplots
* Pop culture references that age quickly
* Heavy moral lectures
...
* Violence, weapons, or physical harm played for drama
* Scary monsters, nightmares, or horror tones
* Death, serious illness, or trauma (unless teacher Notes explicitly request a gentle variant)
* Romance beyond family affection
* Stereotypes or mockery of any character
* Complex idioms, slang, or sarcasm

Acceptable tension:

* Lost toy found again
* Spilled juice cleaned up
* Nino unsure of a new word, then learns it
* Mild weather inconvenience (rain, wind)
...
* Introduce each target word on pages 2–4 in context
